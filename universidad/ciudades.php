  ...
  <div class="row page-titles">
   ...
   <div class="col-md-7 align-self-center text-right">
    <div class="d-flex justify-content-end align-items-center">
     <button onclick="cargarcombodepartamentos();" id="buttoAddCity" data-toggle="modal" data-target="#myModal" type="button" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Registrar Ciudad</button>
   </div>
 </div>
      ...
      <div class="card">
       <div class="card-body">
        ...
        <div class="table-responsive m-t-40">
         <table id="datatableCiudades" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
          <thead>
           <tr>
            <th>Id</th>
            <th>Código</th>
...
<!-- /row modal registra Ciudad-->
<div class="row">
 <div id="myModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
  <div class="modal-dialog" style="width: 70%">
   <div class="modal-content" >
    <div class="modal-header">
     <h4 class="modal-title" id="myModalLabel">Registrar Ciudad</h4>
   ...
   <form id="frmDatos" method="POST" enctype="multipart/form-data" >
     <div class="modal-body">
      ...
      <div class="form-group">
       <label for="message-text" class="control-label">Nombre Ciudad:</label>
       <textarea class="form-control" id="nombreciudad" name="nombreciudad" style="height: 40px" required></textarea>
     </div>

     <div class="form-group">
       <label for="message-text" class="control-label">Código Ciudad:</label>
       <textarea class="form-control" id="codigociudad" name="codigociudad" style="height: 40px" required></textarea>
     </div>

     <div class="form-group">
       <label for="message-text" class="control-label">Departamento:</label>
       <select name="selectDepto" id="selectDepto" class="custom-select" required="">
...
<div class="row">
 <div id="myModal2" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
  <div class="modal-dialog" style="width: 70%">
   <div class="modal-content" >
    <div class="modal-header">
     <h4 class="modal-title" id="myModalLabel">Actualizar Ciudad</h4>
     <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
   </div>
   <form id="frmDatos2" method="POST" enctype="multipart/form-data" >
     <div class="modal-body">
      ...
      <div class="form-group">
       <label for="message-text" class="control-label">Nombre Ciudad:</label>
       <textarea class="form-control" id="nombreciudad2" name="nombreciudad2" style="height: 40px" required></textarea>
     </div>

     <div class="form-group">
       <label for="message-text" class="control-label">Código Ciudad:</label>
       <textarea class="form-control" id="codigociudad2" name="cogidociudad2" style="height: 40px" required></textarea>
     </div>

     <div class="form-group">
       <label for="message-text" class="control-label">Departamento:</label>
       <select name="selectDepto2" id="selectDepto2" class="custom-select" required="">
       </select>
     </div>
     ...
     <div class="modal-footer">
       <button type="button" class="btn btn-info waves-effect" data-dismiss="modal">Cerrar</button>
       <button type="submit" id="actualizar-ciudad2" class="btn btn-info waves-effect waves-light">Guardar</button>
     </div>
   </div>
 </form>
</div>
...
<div class="row">
 <div id="myModal3" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
  <div class="modal-dialog" style="width: 70%">
   <div class="modal-content" >
    <div class="modal-header">
     <h4 class="modal-title" id="myModalLabel">Borrar Ciudad</h4>
     <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
   </div>
   <form id="frmDatos3" method="POST" enctype="multipart/form-data" >
     <div class="modal-body">
      ...
      <div class="form-group">
       <label for="message-text" class="control-label">¿Esta seguro que desea eliminar la Ciudad? </label>
     </div>
     ...
     <div class="modal-footer">
       ...
       <button type="submit" id="borrarciudad2" class="btn btn-info waves-effect waves-light">Eliminar</button>
     </div>
   </div>
 </form>
</div>
...
<script src="codigoJs/ciudades.js"></script>
