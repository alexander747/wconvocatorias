...
<div class="row">
 <div class="col-12">
  <div class="card">
   <div class="card-body">
    <h3 class="card-title" style="color:blue" align="center">CONVOCATORIAS</h3  >
    <div class="col-12 m-t-30">
      <p class="text-muted m-t-0 font-12"><h4 style="color:blue" align="center">Seleccione la convocatoria en la que desea registrarse</h4></p>
    </div>
