 ...
 <div class="container-fluid">
  ...
  <div class="col-md-7 align-self-center text-right">
    <div class="d-flex justify-content-end align-items-center">
     <button id="buttoAddDepto" data-toggle="modal" data-target="#myModal" type="button" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Registrar Departamento</button>
   </div>
 </div>
  ...
  <div class="card">
   <div class="card-body">
    ...
    <div class="table-responsive m-t-40">
     <table id="datatableDepartamento" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
      <thead>
       <tr>
        <th>Id</th>
        <th>Código</th>
...
<!-- /row modal registra departamento-->
<div class="row">
  ...
  <div class="modal-dialog" style="width: 70%">
   ...
   <form id="frmDatos" method="POST" enctype="multipart/form-data" >
     <div class="modal-body">
      ...
      <div class="form-group">
       <label for="message-text" class="control-label">Nombre Departamento:</label>
       <textarea class="form-control" id="nombredepto" name="nombredepto" style="height: 40px" required></textarea>
     </div>

     <div class="form-group">
       <label for="message-text" class="control-label">Id Departamento:</label>
       <textarea class="form-control" id="codigodepto" name="codigodepto" style="height: 40px" required></textarea>
     </div>
     ...
     <div class="modal-footer">
       ...
       <button type="submit" id="guardar-depto" class="btn btn-info waves-effect waves-light">Guardar</button>
     </div>
   </div>
 </form>
</div>
  ...
  <div class="modal-dialog" style="width: 70%">
   ...
   <form id="frmDatos2" method="POST" enctype="multipart/form-data" >
     <div class="modal-body">
      ...
      <div class="form-group">
       <label for="message-text" class="control-label">Nombre de departamento:</label>
       <textarea class="form-control" id="nombredepto2" name="nombredepto2" style="height: 40px" required></textarea>
     </div>

     <div class="form-group">
       <label for="message-text" class="control-label">id departamento:</label>
       <textarea class="form-control" id="codigodepto2" name="codigodepto2" style="height: 40px" required></textarea>
     </div>
     ...
     <div class="modal-footer">
       <button type="button" class="btn btn-info waves-effect" data-dismiss="modal">Cerrar</button>
       <button type="submit" id="actualizar-depto2" class="btn btn-info waves-effect waves-light">Guardar</button>
     </div>
   </div>
 </form>
</div>
...
<div class="row">
 <div id="myModal3" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
  <div class="modal-dialog" style="width: 70%">
   <div class="modal-content" >
    <div class="modal-header">
     <h4 class="modal-title" id="myModalLabel">Borrar Departamento</h4>
     <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
   </div>
   <form id="frmDatos3" method="POST" enctype="multipart/form-data" >
     <div class="modal-body">
      ...
      <div class="form-group">
       <label for="message-text" class="control-label">¿Esta seguro que desea eliminar el Departamento? </label>
     </div>
...
<script src="codigoJs/departamentos.js"></script>
