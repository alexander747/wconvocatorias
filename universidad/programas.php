...
<head>
	...
	<title>Sistema de Gestion - Programas</title>
  ...
  <body class="skin-blue fixed-layout">
  	...
  	<div class="preloader">
  		<div class="loader">
  			...
  			<p class="loader__label">Sistema de Gestion - Programas</p>
  		</div>
  	</div>
  	<!-- ============================================================== -->
  					...
  					<ul class="navbar-nav my-lg-0">
  						...
  						<li class="nav-item dropdown">
  							...
  							<div class="dropdown-menu dropdown-menu-right mailbox animated bounceInDown">
  									...
  									<li>
  										...
  										<div class="page-wrapper">
  											...
  											<div class="container-fluid">
  												...
  												<div class="row page-titles">
  													...
  													<div class="col-md-7 align-self-center text-right">
  														<div class="d-flex justify-content-end align-items-center">
  															<button id="buttoAddprograma" data-toggle="modal" data-target="#myModal" type="button" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Registrar Programa</button>
  														</div>
  													</div>
  														...
  														<div class="card">
  															<div class="card-body">
  																...
  																<div class="table-responsive m-t-40">
  																	<table id="datatableProgramas" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
  																		<thead>
  																			<tr>
  																				<th>Id</th>
  																				<th>Codigo</th>
  												...
  												<!-- /row modal registra programa-->
  												<div class="row">
  													<div id="myModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
  														<div class="modal-dialog" style="width: 70%">
  															<div class="modal-content" >
  																<div class="modal-header">
  																	<h4 class="modal-title" id="myModalLabel">Registrar Programas</h4>
  																...
  																<form id="frmDatos" method="POST" enctype="multipart/form-data" >
  																	<div class="modal-body">
  																		...
  																		<div class="form-group">
  																			<label for="message-text" class="control-label">Nombre Programa:</label>
  																			<textarea class="form-control" id="nombreprograma" name="nombreprograma" style="height: 40px" required></textarea>
  																		</div>

  																		<div class="form-group">
  																			<label for="message-text" class="control-label">Codigo Programa:</label>
  																			<textarea class="form-control" id="codigoprograma" name="codigoprograma" style="height: 40px" required></textarea>
  																		</div>
  																		...
  																		<div class="modal-footer">
  																			...
  																			<button type="submit" id="guardar-programa" class="btn btn-info waves-effect waves-light">Guardar</button>
  																		</div>
  																	</div>
  																</form>
  															</div>
  															...
  															<div class="modal-content" >
  																...
  																<form id="frmDatos2" method="POST" enctype="multipart/form-data" >
  																	<div class="modal-body">
  																		...
  																		<div class="form-group">
  																			<label for="message-text" class="control-label">Nombre de Programa:</label>
  																			<textarea class="form-control" id="nombreprograma2" name="nombreprograma2" style="height: 40px" required></textarea>
  																		</div>

  																		<div class="form-group">
  																			<label for="message-text" class="control-label">Codigo Programa:</label>
  																			<textarea class="form-control" id="codigoprograma2" name="codigoprograma2" style="height: 40px" required></textarea>
  																		</div>
  																		...
  																		<div class="modal-footer">
  																			<button type="button" class="btn btn-info waves-effect" data-dismiss="modal">Cerrar</button>
  																			<button type="submit" id="actualizar-programa2" class="btn btn-info waves-effect waves-light">Guardar</button>
  																		</div>
  																	</div>
  																</form>
  															</div>
  															...
  															<div class="modal-content" >
  																...
  																<form id="frmDatos3" method="POST" enctype="multipart/form-data" >
  																	<div class="modal-body">
  																		...
  																		<div class="form-group">
  																			<label for="message-text" class="control-label">¿Esta seguro que desea eliminar el Programa? </label>
  																		</div>
  																		...
  																		<div class="modal-footer">
  																			...
  																			<button type="submit" id="actualizar-depto2" class="btn btn-info waves-effect waves-light">Eliminar</button>
  																		</div>
  																	</div>
  																</form>
  															</div>
  								...
  								<script src="codigoJs/programas.js"></script>
