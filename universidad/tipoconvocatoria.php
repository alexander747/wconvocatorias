          ...
          <li class="nav-item dropdown">
           ...
           <div class="dropdown-menu dropdown-menu-right mailbox animated bounceInDown">
                        ...
                        <form id="frmDatos" method="POST" enctype="multipart/form-data" >
                         <div class="modal-body">
                          ...
                          <div class="form-group">
                           ...
                           <div>
                            <input type="radio" class="check" id="radio3" name="url" data-radio="iradio_flat-red" value="jovenesinvestigacion.php">
                            <label for="radio3">Jovenes de Investigación</label><br>
                            <input type="radio" class="check" id="radio4" name="url" checked data-radio="iradio_flat-red" value="gruposinvestigacion.php">
                            <label for="radio4">Grupos de Investigación</label>
                           </div>
                          </div>
            ...
            <div class="form-group">
             <label for="message-text" class="control-label">Destino:</label>
             <div>
              <input type="radio" class="check" id="radio5" name="acturl" data-radio="iradio_flat-red" value="jovenesinvestigacion.php">
              <label for="radio5">Jovenes de Investigación</label><br>
              <input type="radio" class="check" id="radio6" name="acturl" data-radio="iradio_flat-red" value="gruposinvestigacion.php">
              <label for="radio6">Grupos de Investigación</label>
             </div>
            </div>
