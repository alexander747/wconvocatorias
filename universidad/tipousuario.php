...
<head>
	...
	<title>Sistema de Gestion - Tipos de Usuario</title>
  ...
  <body class="skin-blue fixed-layout">
  	...
  	<div class="preloader">
  		<div class="loader">
  			...
  			<p class="loader__label">Sistema de gestion - Tipos de Usuario</p>
  		</div>
  	</div>
  	<!-- ============================================================== -->
  					...
  					<ul class="navbar-nav my-lg-0">
  						...
  						<li class="nav-item dropdown">
  							...
  							<div class="dropdown-menu dropdown-menu-right mailbox animated bounceInDown">
  											...
  											<div class="container-fluid">
  												...
  												<div class="row page-titles">
  													...
  													<div class="col-md-7 align-self-center text-right">
  														<div class="d-flex justify-content-end align-items-center">
  															<button id="buttoAddusuario" data-toggle="modal" data-target="#myModal" type="button" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Registrar Tipo de Usuario</button>
  														</div>
  													</div>
  												...
  												<div class="row">
  													<div class="col-12">
  														<div class="card">
  															<div class="card-body">
  																<h4 class="card-title">Tipos de Usuario</h4>
  																<div class="table-responsive m-t-40">
  																	<table id="datatableTusuario" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
  																		<thead>
  																			<tr>
  																				<th>Id</th>
  																				<th>Nombre</th>
  												...
  												<!-- /row modal registra tipo de Usuario-->
  												<div class="row">
  													<div id="myModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
  														<div class="modal-dialog" style="width: 70%">
  															<div class="modal-content" >
  																<div class="modal-header">
  																	<h4 class="modal-title" id="myModalLabel">Registrar Tipo de Usuario</h4>
  																...
  																<form id="frmDatos" method="POST" enctype="multipart/form-data" >
  																	<div class="modal-body">
  																		...
  																		<div class="form-group">
  																			<label for="message-text" class="control-label">Tipo Usuario:</label>
  																			<textarea class="form-control" id="nombreTusuario" name="nombreTusuario" style="height: 40px" required></textarea>
  																		</div>
  																...
  																<form id="frmDatos2" method="POST" enctype="multipart/form-data" >
  																	<div class="modal-body">
  																		...
  																		<div class="form-group">
  																			...
  																			<textarea class="form-control" id="nombreTusuario2" name="nombreTusuario2" style="height: 40px" required></textarea>
  																		</div>
  																		...
  																		<div class="modal-footer">
  																			<button type="button" class="btn btn-info waves-effect" data-dismiss="modal">Cerrar</button>
  																			<button type="submit" id="actualizar-Tusuario2" class="btn btn-info waves-effect waves-light">Guardar</button>
  																		</div>
  																	</div>
  																</form>
  															</div>
  															...
  															<div class="modal-content" >
  																...
  																<form id="frmDatos3" method="POST" enctype="multipart/form-data" >
  																	<div class="modal-body">
  																		...
  																		<div class="form-group">
  																			<label for="message-text" class="control-label">¿Esta seguro que desea eliminar tipo de Usuario? </label>
  																		</div>
  																		...
  																		<div class="modal-footer">
  																			...
  																			<button type="submit" id="actualizar-Tusuario2" class="btn btn-info waves-effect waves-light">Eliminar</button>
  																		</div>
  																	</div>
  																</form>
  															</div>
  								...
  								<script src="codigoJs/tipousuario.js"></script>
