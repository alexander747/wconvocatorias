  												...
  												<div class="row page-titles">
  													...
  													<div class="col-md-7 align-self-center text-right">
  														<div class="d-flex justify-content-end align-items-center">
  															<button id="buttoAddusuario" data-toggle="modal" data-target="#myModal" type="button" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Registrar usuario</button>
  														</div>
  													</div>
  																...
  																<form id="frmDatos" method="POST" enctype="multipart/form-data" >
  																	<div class="modal-body">
  																		...
  																		<div class="form-group">
  																			...
  																			<textarea class="form-control" id="apellidosUsuario" name="apellidosUsuario" style="height: 40px" required></textarea>
  																		</div>

																		<div class="form-group">
	 																			<label for="message-text" class="control-label">Identificacion :</label>
	 																			<textarea class="form-control" id="identificacionUsuario" name="identificacionUsuario" style="height: 40px" required></textarea>
																		</div>

																		<!-- <div class="form-group">
		                                    <label>Tipo de Identificacion</label>
		                                    <select class="custom-select col-12" id="tipoIdusuario" name="tipoIdusuario" style="height: 40px" required>
		                                        ...
		                                        <option value="CE">CE-Cedula de Extranjeria</option>
																	...
																	<div class="form-group">
	 																			...
	 																			<textarea class="form-control" id="tipoIdusuario" name="tipoIdusuario" style="height: 40px" required></textarea>
																		</div>
<!--
																		...
																		<div class="form-group">
																				...
																				<textarea class="form-control" id="nacimientoUsuario" name="nacimientoUsuario" style="height: 40px" required></textarea>
																		</div>

  																	<div class="form-group">
	 																			<label for="message-text" class="control-label">Ciudad de Nacimiento:</label>
	 																			<textarea class="form-control" id="ciudadNUsuario" name="ciudadNUsuario" style="height: 40px" required></textarea>
																		</div>

																		<div class="form-group">
	 																			<label for="message-text" class="control-label">Ciudad Residencia :</label>
	 																			<textarea class="form-control" id="ciudadRUsuario" name="ciudadRUsuario" style="height: 40px" required></textarea>
																		</div>


  																	<div class="form-group">
	 																			<label for="message-text" class="control-label">Direccion :</label>
																				<textarea class="form-control" id="direccionusuario" name="direccionusuario" style="height: 40px" required></textarea>
																		</div>

																		<div class="form-group">
																				<label for="message-text" class="control-label">Barrio :</label>
																				<textarea class="form-control" id="barrioUsuario" name="barrioUsuario" style="height: 40px" required></textarea>
																		</div>


		  															<div class="form-group">
																				<label for="message-text" class="control-label">Telefono :</label>
																				<textarea class="form-control" id="telefonoUsuario" name="telefonoUsuario" style="height: 40px" required></textarea>
																		</div>


																		<div class="form-group">
																				<label for="message-text" class="control-label">Correo:</label>
																				<textarea class="form-control" id="correoUsuario" name="correoUsuario" style="height: 40px" required></textarea>
																		</div>

																		<div class="form-group">
	 																			<label for="message-text" class="control-label">Nivel de Formacion :</label>
	 																			<textarea class="form-control" id="formacionUsuario" name="formacionUsuario" style="height: 40px" required></textarea>
																		</div>
																		<!-- <div class="form-group">
																		...
																		<div class="form-group">
			  																...
			  																<textarea class="form-control" id="Profesionusuario" name="Profesionusuario" style="height: 40px" required></textarea>
																		</div>

																		<div class="form-group">
																				<label for="message-text" class="control-label">Tipo de Usuario :</label>
																				<textarea class="form-control" id="tipoUsuario" name="tipoUsuario" style="height: 40px" required></textarea>
																		</div>

																		<div class="form-group">
																				<label for="message-text" class="control-label">Password :</label>
																				<textarea class="form-control" id="passwordUsuario" name="passwordUsuario" style="height: 40px" required></textarea>
																		</div>
